...
Ajoute un corps statique (immobile). À utiliser pour le terrain et les obstacles fixes. Retourne un handle avec `bodyId`, `active`, `enable()` et `disable()` pour activer/désactiver le corps.
